...
class SantaBallotBoxTestCase(TestCase):
    ...
    def test_ballot_box_update_target_state_to_partially_allowlisted_to_globally_allowlisted(self):
        ...
        self.assertEqual(
            ballot_box2._events,
            [(SantaBallotEvent,
              {'created_at': ballot.created_at.isoformat(),
               'event_target': None,
               'pk': str(ballot.pk),
             ...
             (SantaTargetStateUpdateEvent,
              {'configuration': {'name': configuration.name, 'pk': configuration.pk},
               'created_at': ts2.created_at.isoformat(),
               ...
               'target': {'sha256': self.file_sha256,
                          'type': 'BINARY'},
               'updated_at': ts2.updated_at.isoformat()}),
        ...
        self.assertEqual(
            ...
            [(SantaBallotEvent,
             ...
             (SantaTargetStateUpdateEvent,
              {'configuration': {'name': configuration.name, 'pk': configuration.pk},
               'created_at': ts3.created_at.isoformat(),
               'new_value': {'flagged': False,
                             'reset_at': None,
                             'score': 9,
                             'state': 50,
               ...
               'target': {'sha256': self.file_sha256,
                          'type': 'BINARY'},
               'updated_at': ts3.updated_at.isoformat()}),
             (SantaRuleUpdateEvent,
              {'result': 'updated',
               'rule': {'configuration': {'name': configuration.name, 'pk': configuration.pk},
                        'is_voting_rule': True,
        ...
        self.assertEqual(
            ...
            [(SantaBallotEvent,
             ...
             (SantaTargetStateUpdateEvent,
              {'configuration': {'name': configuration.name, 'pk': configuration.pk},
               'created_at': ts4.created_at.isoformat(),
               'new_value': {'flagged': False,
                             'reset_at': None,
                             'score': 12,
                             'state': 100,
               ...
               'target': {'sha256': self.file_sha256,
                          'type': 'BINARY'},
               'updated_at': ts4.updated_at.isoformat()}),
             (SantaRuleUpdateEvent,
              {'result': 'updated',
               'rule': {'configuration': {'name': configuration.name, 'pk': configuration.pk},
                        'is_voting_rule': True,
