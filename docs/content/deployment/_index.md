...
For the more adventurous, we maintain [Docker with docker-compose](docker-compose.md) deployments. They can be used to evaluate Zentral and for simple setups. We also use them internally to work on Zentral.
