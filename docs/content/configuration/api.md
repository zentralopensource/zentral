...
In this [section](_index.md#sections), we give Zentral information about its deployment: where it is running, which certificates and keys are used. We also define a secret to authenticate some API requests.
