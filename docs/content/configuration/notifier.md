...
In this [section](_index.md#sections), we can configure the redis server used to invalidate cached DB objects. This is a core component of a Zentral deployment.
