...
You can deploy it on your machine with [Docker](deployment/docker-compose.md).
...
See [Event stores](configuration/stores.md) for the options of each backend.
