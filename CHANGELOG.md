...
The Path regexes tab gives one row for each part of the two patterns Zentral sends: the patterns of the configuration itself, and the scoped path regex that won each pattern with the field that decided for the machine.
