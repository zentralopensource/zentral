# Generated by Django 4.2.8 on 2024-01-29 08:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterUniqueTogether(
            name='realmuser',
            unique_together={('realm', 'scim_external_id'), ('realm', 'username')},
        ),
        migrations.CreateModel(
        ...
        migrations.AlterUniqueTogether(
            name='realmgroup',
            unique_together={('realm', 'scim_external_id'), ('realm', 'display_name')},
        ),
    ]
