...
urlpatterns = [
    ...
    path('enrollments/custom_views/<uuid:pk>/download/',
         views.EnrollmentCustomViewDownloadView.as_view(),
         name="download_enrollment_custom_view"),
    ...
    path('artifacts/create/asset/',
         ...
         name="create_asset"),
    path('artifacts/create/cert_asset/',
         views.CreateCertAssetView.as_view(),
         name="create_cert_asset"),
    ...
    path('artifacts/upload/profile/',
         ...
         name="upload_profile"),
    path('artifacts/upload/provisioning_profile/',
         views.UploadProvisioningProfileView.as_view(),
         name="upload_provisioning_profile"),
    ...
    path('artifacts/<uuid:pk>/upgrade_cert_asset/',
         views.UpgradeCertAssetView.as_view(),
         name="upgrade_cert_asset"),
    ...
    path('artifacts/<uuid:pk>/upgrade_provisioning_profile/',
         views.UpgradeProvisioningProfileView.as_view(),
         name="upgrade_provisioning_profile"),
    ...
    path('provisioning_profiles/<uuid:artifact_version_pk>/download/',
         views.DownloadProvisioningProfileView.as_view(),
         name="download_provisioning_profile"),
    ...
    path('assets/<int:pk>/',
         ...
         name="asset"),
    path('assets/<int:asset_pk>/location_assets/<int:pk>/associate/',
         views.AssociateLocationAssetView.as_view(),
         name="associate_location_asset"),
    ...
    path('packages/create/',
         ...
         name="create_package"),
    path('packages/<uuid:pk>/',
         views.PackageView.as_view(),
         name="package"),
    path('packages/<uuid:pk>/update/',
         views.UpdatePackageView.as_view(),
         name="update_package"),
    path('packages/<uuid:pk>/delete/',
         views.DeletePackageView.as_view(),
         name="delete_package"),
    path('packages/<uuid:pk>/download/',
         views.DownloadPackageView.as_view(),
    ...
    path('devices/<int:pk>/commands/feed/',
         views.EnrolledDeviceCommandFeedView.as_view(),
         name="enrolled_device_command_feed"),
    path('devices/<int:pk>/commands/list/feed/',
         views.EnrolledDeviceCommandsFeedView.as_view(),
         name="enrolled_device_commands_feed"),
