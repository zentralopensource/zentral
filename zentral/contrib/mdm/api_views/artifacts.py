...
from zentral.contrib.mdm.models import Artifact, Declaration, EnterpriseApp, Profile
from zentral.contrib.mdm.serializers import (ArtifactSerializer, DeclarationSerializer,
