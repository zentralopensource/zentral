...
from drf_spectacular.utils import OpenApiExample, OpenApiResponse, OpenApiParameter, extend_schema, extend_schema_view
...
class CreateEnrolledDeviceCommandView(CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        serializer = self.get_serializer(command.db_command)
