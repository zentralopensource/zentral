...
urlpatterns = [
    ...
    path('configurationpacks/', ConfigurationPackList.as_view(), name="configuration_packs"),
    path('configurationpacks/<int:pk>/', ConfigurationPackDetail.as_view(), name="configuration_pack"),
    ...
    path('packqueries/', PackQueryList.as_view(), name="pack_queries"),
    path('packqueries/<int:pk>/', PackQueryDetail.as_view(), name="pack_query"),
