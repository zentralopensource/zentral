...
urlpatterns = [
    ...
    # command. No create, update or delete: an operator defines a command through the API, like
    # a store or a probe action. Every definition link needs the detail page.
