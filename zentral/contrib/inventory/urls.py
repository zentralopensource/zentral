...
urlpatterns = [
    ...
    path('machine/<str:urlsafe_serial_number>/tags/<int:tag_id>/create/',
         views.CreateMachineTagView.as_view(),
         name='create_machine_tag'),
    path('machine/<str:urlsafe_serial_number>/tags/<int:tag_id>/delete/',
         views.DeleteMachineTagView.as_view(),
         name='delete_machine_tag'),
