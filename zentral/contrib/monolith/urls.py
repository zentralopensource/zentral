...
urlpatterns = [
    ...
    path('pkg_infos/create/', views.CreatePkgInfoNameView.as_view(), name='create_pkg_info_name'),
    path('pkg_infos/<int:pk>/', views.PkgInfoNameView.as_view(), name='pkg_info_name'),
    path('pkg_infos/<int:pk>/events/',
         views.PkgInfoNameEventsView.as_view(),
         name='pkg_info_name_events'),
    path('pkg_infos/<int:pk>/events/fetch/',
         views.FetchPkgInfoNameEventsView.as_view(),
         name='fetch_pkg_info_name_events'),
    path('pkg_infos/<int:pk>/events/store_redirect/',
         views.PkgInfoNameEventsStoreRedirectView.as_view(),
         name='pkg_info_name_events_store_redirect'),
    path('pkg_infos/<int:pk>/delete/', views.DeletePkgInfoNameView.as_view(), name='delete_pkg_info_name'),
